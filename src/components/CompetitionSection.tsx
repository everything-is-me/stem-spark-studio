...
const competitions = [
  {
    id: "ssef",
    title: "South Indian Science and Engineering Fair",
    subtitle: "South India's largest pre-college science competition",
    description:
      "",
    image: c1,
  ...
  {
    id: "sjic",
    title: "South Indian Junior Innovation Challenge",
    subtitle:
      "The premier science and engineering competition for middle school students.",
    description:
      "",
    image: c2,
    ...
    <section className="py-20 bg-card text-foreground relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-heading font-bold mt-4 text-foreground" style={{ textShadow: '3px 3px 0px rgba(80, 20, 100, 0.4)' }}>Brains &gt; Brawn</h2>
